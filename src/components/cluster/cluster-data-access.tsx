...
// if your network 403, pls change your [private endpoint](https://solana.com/rpc)
export const defaultClusters: Cluster[] = [
  {
    name: 'mainnet-beta',
    endpoint: 'https://mainnet.helius-rpc.com/?api-key=55198e49-ee6d-40d7-8fe2-e3b5ad88959c',
...
export function ClusterProvider({ children }: { children: ReactNode }) {
  ...
  const value: ClusterProviderContext = useMemo(
    ...
    [cluster, setCluster, clusters, setClusters],
  );
